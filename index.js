...
import { View, Animated, ListView, Dimensions, PanResponder, LayoutAnimation, InteractionManager } from 'react-native';
...
class SortableListView extends React.Component {
  ...
  render() {
    const dataSource = this.state.ds.cloneWithRows(this.props.data, this.props.order);
    const scrollEnabled = !this.state.active && this.props.scrollEnabled !== false;
